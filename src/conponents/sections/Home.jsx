      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I'm a UI/UX Designer focused on creating intuitive, user-centered
            digital experiences, and modern tools, I strive to deliver
            meaningful solutions that enhance user satisfaction and achieve
            business goals.
          </p>
          <div className="flex justify-center space-x-6">
            ...
            duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] hover:bg-blue-500/10"
            >
              Contact Me
            </a>
          </div>
